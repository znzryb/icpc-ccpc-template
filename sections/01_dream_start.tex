...
\end{minted}
		...
		\begin{enumerate}
			\item 开始菜单 → \textbf{设置}：
			      \begin{center}
				      \includegraphics[width=0.6\linewidth]{image/ime_win10_01_开始菜单设置.jpg}
			      \end{center}
			\item 进入\textbf{时间和语言}：
			      \begin{center}
				      \includegraphics[width=\linewidth]{image/ime_win10_02_时间和语言.jpg}
			      \end{center}
			\item 左侧栏切到\textbf{语言}：
			      \begin{center}
				      \includegraphics[width=\linewidth]{image/ime_win10_03_左栏语言.jpg}
			      \end{center}
			\item 「首选语言」列表里点\textbf{中文(简体，中国)}：
			      \begin{center}
				      \includegraphics[width=\linewidth]{image/ime_win10_04_首选语言点中文.jpg}
			      \end{center}
			\item 点展开出来的\textbf{选项}按钮：
			      \begin{center}
				      \includegraphics[width=\linewidth]{image/ime_win10_05_选项按钮.jpg}
			      \end{center}
			\item 键盘列表里点\textbf{微软拼音} → 进入\textbf{按键}：
			      \begin{center}
				      \includegraphics[width=0.85\linewidth]{image/ime_win10_06_微软拼音按键.jpg}
			      \end{center}
			\item 「中/英文模式切换」里\textbf{把 \texttt{Shift} 的勾去掉}（保留 \texttt{Ctrl + 空格键}，这就是之后手动切中英文的键）：
			      \begin{center}
				      \includegraphics[width=\linewidth]{image/ime_win10_07_取消Shift勾选.jpg}
			      \end{center}
		\end{enumerate}
		...
		\begin{enumerate}
			\item 任务栏搜狗图标打开工具面板 → \textbf{更多设置(P)}：
			      \begin{center}
				      \includegraphics[width=0.55\linewidth]{image/ime_sogou_01_更多设置.jpg}
			      \end{center}
			\item 属性设置 → \textbf{按键} → 「中英切换」选\textbf{无}（不想彻底禁可选 \texttt{Ctrl}）：
			      \begin{center}
				      \includegraphics[width=\linewidth]{image/ime_sogou_02_中英切换选无.jpg}
			      \end{center}
		\end{enumerate}
