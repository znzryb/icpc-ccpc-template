...
% 目录
	...
	\input{sections/03_count_combinatorics.tex}
	\input{sections/04_game_theory.tex}
	\input{sections/05_bitwise_identities.tex}
	\input{sections/06_basic_algorithm.tex}
	\input{sections/07_data_structure.tex}
	\input{sections/08_graph.tex}
	\input{sections/09_string_algorithm.tex}
	\input{sections/10_dp.tex}
	\input{sections/11_geometry.tex}
	\input{sections/12_stl.tex}
	\input{sections/13_common_pitfalls.tex}
	\input{sections/14_debug_tricks.tex}
	\input{sections/15_env_test.tex}
	\input{sections/16_misc_tricks.tex}
